...
- (void)setup{
    ...
    _targetViewScale = 0.5f;
    _portalAnimationDuration = 2.0f;
    _scaleAnimationDuration = 2.0f;
    _delay = 0.5f;
}
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext;
{
    ...
    [UIView animateWithDuration:_scaleAnimationDuration delay:_delay options:UIViewAnimationOptionCurveEaseInOut animations:^{
        ...
        reflectionView.frame = CGRectMake(0, fromViewSize.height + self.reflectionGap, fromViewSize.width, fromViewSize.height/2);
        
        if (self.portalTransitionStyle == CYPortalTransitionStylePush) {
        ...
        if (self.portalTransitionStyle == CYPortalTransitionStylePresent) {
