...
- (void)addContent {
    ...
    image.image=[[UIImage imageNamed:@"upshadow"] stretchableImageWithLeftCapWidth:5 topCapHeight:30];
    ...
    image1.image=[[UIImage imageNamed:@"downshadow"] stretchableImageWithLeftCapWidth:5 topCapHeight:30];
