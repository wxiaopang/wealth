...
@interface ShareEngine () < MFMessageComposeViewControllerDelegate,
...
SYNTHESIZE_SINGLETON_FOR_CLASS(ShareEngine)
...
+ (void)reset {
    [[ShareEngine sharedShareEngine] resetAll];
}
...
+ (void)shareContent:(NSDictionary *)userInfo
    ...
    switch (type) {
        ...
        case ShareType_WeChatTimeLine: {
            [[ShareEngine sharedShareEngine] sendWeChatMessageTitle:title
        ...
        case ShareType_QQ: {
            [[ShareEngine sharedShareEngine] sendQQMessageTitle:title
                                                    description:description
                                                    contentType:contentType
                                                        WithUrl:url
                                                          image:image
        ...
        case ShareType_QZone: {
            [[ShareEngine sharedShareEngine] sendQZoneMessageTitle:title
                                                       description:description
                                                       contentType:contentType
                                                           WithUrl:url
                                                             image:image
        ...
        case ShareType_SMS: {
            [[ShareEngine sharedShareEngine] sendSMS:description complete:complete];
        }
            break;

        case ShareType_Mail: {
            [[ShareEngine sharedShareEngine] sendEmail:description complete:complete];
        }
            break;
...
- (void)sendSMS:(NSString *)message complete:(SMSResultBlock)complete {
    ...
    if (messageClass != nil) {
        ...
        if ([messageClass canSendText]) {
            ...
            picker.body                   = message;
            ROOT_NAVIGATECONTROLLER_PRES(picker);
        }
        else {
            if (complete) {
...
- (void)sendEmail:(NSString *)message complete:(MailResultBlock)complete {
    ...
    if (messageClass != nil) {
        if ([messageClass canSendMail]) {
            ...
            ROOT_NAVIGATECONTROLLER_PRES(vc);
        }
        else {
            if (complete) {
