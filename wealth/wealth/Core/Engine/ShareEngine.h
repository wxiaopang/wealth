...
@interface ShareEngine : NSObject<WXApiDelegate, TencentSessionDelegate, QQApiInterfaceDelegate>

SYNTHESIZE_SINGLETON_FOR_CLASS_HEADER(ShareEngine);

@property (nonatomic, weak) id<ShareEngineDelegate> delegate;
