...
//  wealth
//
//  Created by wangyingjie on 15/1/9.
...
+ (void)animationScaleUp:(UIView *)view {
...
+ (void)animationBreathingEffects:(UIView *)view {
    CABasicAnimation *animation = [CABasicAnimation animationWithKeyPath:@"transform.scale"];
...
+ (void)animationScaleEffects:(UIView *)view {
    CABasicAnimation *animation = [CABasicAnimation animationWithKeyPath:@"transform"];
    animation.repeatCount = 1;
    animation.duration = 0.5;
    animation.autoreverses = NO;
    animation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseIn];
    animation.fromValue = [NSValue valueWithCATransform3D:CATransform3DMakeScale(5.0, 5.0, 1.0)];
