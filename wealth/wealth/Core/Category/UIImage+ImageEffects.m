...
//    UIColor *tintColor = [UIColor colorWithRed:43.0/255.0 green:60.0/255.0 blue:76.0/255.0 alpha:0.90];
    //57 73 88
    UIColor *tintColor = [UIColor colorWithRed:57.0/255.0 green:73.0/255.0 blue:88.0/255.0 alpha:0.90];
    return [self applyBlurWithRadius:20 blurType:BOXFILTER tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
+ (UIImage *)imageWithColor:(UIColor *)color size:(CGSize)size {
    ...
    CGFloat pixelSize = 1 / pixelScale;
    CGSize fillSize = CGSizeMake(pixelSize, pixelSize);
    CGRect fillRect = CGRectMake(0, 0, fillSize.width, fillSize.height);
...
- (UIImage *)addWatermarkForText:(NSString *)mark {
    ...
    NSDictionary *dic = @{ NSFontAttributeName:[UIFont systemFontOfSize:50.0f],
                           NSForegroundColorAttributeName:[UIColor colorWithRed:220.0f/255.0f green:220.0f/255.0f blue:220.0f/255.0f alpha:1.0f] };
    CGSize size = [mark boundingRectWithSize:CGSizeMake(w, h)
                                     options:NSStringDrawingTruncatesLastVisibleLine
                                  attributes:dic
                                     context:nil].size;

    [mark drawInRect:CGRectMake((w - size.width)/2, 16, size.width, size.height) withAttributes:dic];
...
- (UIImage *)addWatermarkForImage:(UIImage *)watermarkImage {
    ...
    [watermarkImage drawInRect:CGRectMake((self.size.width - watermarkImage.size.width)/2,
                                          16,
